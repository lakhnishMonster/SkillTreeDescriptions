...
if GLOBAL.CurrentRelease.GreaterOrEqualTo("R30_ST_WOODWOLFWORM") then
	...
	GLOBAL.STRINGS.SKILLTREE.WORMWOOD.BLOOMING_PHOTOSYNTHESIS_DESC = "While in full bloom, regenerate 1 health every 20 seconds when exposed to strong sunlight."	
	...
	GLOBAL.STRINGS.SKILLTREE.WOODIE.WOODIE_HUMAN_QUICKPICKER_1_DESC = "Collect harvestable items in 15% less time."--Total harvest time is x seconds. (default)
	GLOBAL.STRINGS.SKILLTREE.WOODIE.WOODIE_HUMAN_QUICKPICKER_2_DESC = "Collect harvestable items in 30% less time."--Total harvest time is x seconds. (default)
	GLOBAL.STRINGS.SKILLTREE.WOODIE.WOODIE_HUMAN_QUICKPICKER_3_DESC = "Collect harvestable items in 45% less time."--Total harvest time is x seconds. (default)
